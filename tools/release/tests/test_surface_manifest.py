...
class SurfaceManifestTests(unittest.TestCase):
    ...
    def test_schema_and_entry_shapes(self) -> None:
        ...
        self.assertEqual(self.manifest["integration_contract_version"], 8)
    ...
    def test_frozen_storage_and_event_rows_have_layout_expectations(self) -> None:
        ...
        self.assertEqual(version["layout"], {"type": "u32", "value": "0x08000000"})
            ...
            [
                {
                    ...
                    "owner": "B1b",
                    "reason": (
                        "SQ-173..SQ-175, SQ-181, SQ-182 remain open (fail-closed "
                        "adoption-input backing gaps; per-SQ owners). SQ-177 and "
                        "SQ-180 are resolved and no longer block."
                    ),
                },
                {
                ...
                },
                {
                    ...
                    "reason": (
                        ...
                        "authenticated pass, local F+R line runway, remote sovereign USDC "
                        "plus F+R DOT envelopes/refill margin, and positive TREASURY "
                        "reserve-line funding handover before Phase 4; SQ-484 "
                        "monitoring/alerts and SQ-485 nonzero parameter floors remain "
                        "open; SQ-205/SQ-380 production health/feed wiring is complete"
                    ),
                },
                {
