...
**Current: A1 — `pallet-constitution`**. Initial constitution crate implementation is in progress: typed parameter records, bounded/rate-limited update checks, meters, capability records, `PhaseFlags`, fixed-width `ReleaseChannel`, kernel/contract re-exports, and unit coverage are in place. Remaining A1 work before ✅: convert the crate into a full FRAME pallet with storage/extrinsics/origin wiring, mock-runtime origin-misuse/error-path suites, try-state, and benchmark stubs.
...
| ID | Milestone | Spec | Depends | Status | Notes |
|---|---|---|---|---|---|
| A1 | `pallet-constitution` — typed/bounded/rate-limited params, meters, capability tables, `PhaseFlags`, `ReleaseChannel` fixed-layout key, kernel re-export | 06; 13 §1/§4; 02 §7.3/§12 | M1 | 🔨 | I-6, I-7, I-17; crate-native core types/checks landed, FRAME pallet wiring + mock-runtime/try-state/benchmark obligations remain |
